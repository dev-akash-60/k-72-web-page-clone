    ...
    return (
        <div className='font-[font2] flex items-center justify-center gap-2 '>
            <p className='absolute lg:w-[17vw] w-64 lg:right-20 right-0 bottom-28  lg:bottom-72 font-[font1] lg:text-lg text-xs lg:leading-relaxed leading-tight'>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;K72 is an agency that thinks about every action with the brand in mind. Tomorrow, five months from now, and five years from now. We seek out the friction that creates the spark and sparks emotion. To build an honest relationship, we hold nothing back. We say what needs to be said, and we do what needs to be done.</p>
